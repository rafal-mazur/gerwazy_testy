...
class Device:
	...
	VIDEO_SIZE: tuple[int, int] = (1024, 1024) # VIDEO_SIZE >= PREVIEW_SIZE
	FPS: int = 5 # > 0
	...
	@classmethod
	def VID_TO_PREV_RATIO_X(cls) -> float:
		return cls.VIDEO_SIZE[0] / cls.PREVIEW_SIZE[0]
	
	@classmethod
	def VID_TO_PREV_RATIO_Y(cls) -> float:
		return cls.VIDEO_SIZE[1] / cls.PREVIEW_SIZE[1]
